...
<head>
  ...
  <title>Pengajuan Surat Pengantar Bantuan</title>
	  ...
	  <!-- Content Row -->
          <div class="container-fluid">
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Pengajuan Surat Pengantar Penerimaan Bantuan</h6>
            </div>
            <div class="card-body">
				...
				<b>No. Surat</b>:<br/>
					...
					<select name="surat" class="form-control form-control-user col-sm-4" required>
						<option value="Pengajuan Bantuan PKH">Pengajuan Bantuan PKH</option>
						<option value="Pengajuan Bantuan BPNT Kabupaten/Provinsi/Kemensos">Pengajuan Bantuan BPNT Kabupaten/Provinsi/Kemensos</option>
						<option value="Pengajuan Bantuan BLT Dana Desa">Pengajuan Bantuan BLT Dana Desa </option>
						<option value="Pengajuan Bantuan BLT Kemensos">Pengajuan Bantuan BLT Kemensos</option>
						<option value="Pengajuan Bantuan BST Kementerian/kemensos">Pengajuan Bantuan BST Kementerian/kemensos </option>
						<option value="Pengajuan Bantuan Jaminan Lanjut Usia">Pengajuan Bantuan Jaminan Lanjut Usia</option>
					</select>
					<br/>
