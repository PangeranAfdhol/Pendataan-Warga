...
<br/>
	...
	<table border="2" style="width: 100% ">
		...
		<?php
					$dataSql = mysqli_query($db, "select nik, no_kk, nama, tempatLahir ,tglLahir, alamat, bantuan, rt, rw, dusun, desa, agama, pekerjaan, no_telepon, gender, year(NOW())-year(tglLahir) from penduduk where bantuan = 'BST Kementerian/kemensos'");
