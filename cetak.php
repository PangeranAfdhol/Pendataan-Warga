...
<br/>
<b><u>SURAT PERNYATAAN PENERIMAAN BANTUAN</u></b><br/>
Nomor: " . $_GET['noSurat'] . "<span style='margin-left:60px; margin-right:100px'></span><br/>
</center>";
while($orang = mysqli_fetch_array($cekNik)) {
	...
	Saya Bertanda Tangan Dibawah Ini,<br/>
	Penerima Bantuan<br/>
	<br/>
	<br/>
	<br/>
	...
	<td align='center' width='50%'>
	Desa Suka Maju, " . $_GET['tglSurat'] . "<br/>
